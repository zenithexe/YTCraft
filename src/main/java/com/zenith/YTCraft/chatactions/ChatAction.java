...
/**
 * Interface for YouTube chat actions/interactions
 * Represents actions that viewers can trigger through YouTube chat
 */
public interface ChatAction {
     ...
     */
    boolean execute(LiveChatMessage message, String[] args, int viewers);
